...
namespace CarMaintenanceLibrary.Tests
{
    public class CarMaintenanceTests
    {
        ...
        public void TestRegisterService()
        {
            ...
            car.RegisterServiceHistory("service_history_test.bin", "Audi", 10500, "Service", 1500);
        ...
        public void TestRegisterService_2()
        {
            ...
            car.RegisterServiceHistory("service_history_test_2.bin", "Ferrari", 12500, "Service", 1900);
